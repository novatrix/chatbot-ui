...
const RateLimit = () => {
  ...
  return (
    <div
      className="modal-overlay rate-limit-modal fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50"
      onClick={handleClickOutside}
    >
      <div className="mx-auto max-w-md rounded-lg bg-white p-6 shadow-lg dark:bg-slate-800">
            ...
            >
              ...
              <defs>
                <clipPath id="clip0_39_147">
                  <rect width="354" height="472" fill="white"></rect>
                </clipPath>
              </defs>
            </svg>
          </p>
