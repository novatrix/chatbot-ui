...
AS $$
DECLARE
  project_url TEXT := 'https://qjlrgfdicqzdfddbtqzp.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFqbHJnZmRpY3F6ZGZkZGJ0cXpwIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNjI4NDQ1MiwiZXhwIjoyMDMxODYwNDUyfQ.Ix1O_W0hcCn0jyAx_zDzqCngTicjOrAzjURKKKRZYZk'; -- full access needed for http request to storage
